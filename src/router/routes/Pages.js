...
const PagesRoutes = [
  ...
  //   component: lazy(() =>
  //     import("../../views/gp-app/authentication/RegisterV1")
  //   ),
  //   layout: "BlankLayout",
  // },
  // {
  ...
  //   component: lazy(() =>
  //     import("../../views/gp-app/authentication/RegisterV2")
  //   ),
  //   layout: "BlankLayout",
  // },
  {
    ...
    component: lazy(() =>
      import("../../views/gp-app/authentication/ForgotPassword")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
  ...
  //   component: lazy(() =>
  //     import("../../views/gp-app/authentication/ForgotPasswordV1")
  //   ),
  //   layout: "BlankLayout",
  // },
  // {
  ...
  //   component: lazy(() =>
  //     import("../../views/gp-app/authentication/ForgotPasswordV2.js")
  //   ),
  //   layout: "BlankLayout",
  // },
  {
    path: "/OTP",
    component: lazy(() =>
      import("../../views/gp-app/authentication/OtpVerification.js")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
  ...
  },
  {
    path: "/reset",
    component: lazy(() =>
      import("../../views/gp-app/authentication/resetPassword.js")
    ),
    layout: "BlankLayout",
    meta: {
      authRoute: true,
  ...
  //   component: lazy(() =>
  //     import("../../views/gp-app/authentication/ResetPasswordV1")
  //   ),
  //   layout: "BlankLayout",
  // },
  // {
  ...
  //   component: lazy(() =>
  //     import("../../views/gp-app/authentication/ResetPasswordV2")
  //   ),
  //   layout: "BlankLayout",
  // },
  // {
