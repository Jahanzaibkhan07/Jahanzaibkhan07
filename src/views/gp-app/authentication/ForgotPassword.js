...
const ForgotPassword = () => {
  ...
  const error = forgetPass?.userData?.error;
  const success = forgetPass?.userData?.success;
  const {
    register,
    formState: { errors },
    handleSubmit,
  ...
  const illustration =
      skin === "semi-dark" ? "login-img.svg" : "forgot-password-v2.svg",
    source = require(`@src/assets/images/pages/${illustration}`).default;

  const illustration1 =
      skin === "semi-dark" ? "Logo-Beauty-black.svg" : "login-v2.svg",
    source1 = require(`@src/assets/images/logo/${illustration1}`).default;
        ...
        <Row className="auth-inner m-0">
          ...
          >
            <Col className="px-xl-2 mx-auto" sm="8" md="6" lg="12">
              <CardTitle
                tag="h2"
                className="text-dark font-weight-bold mb-2 display-4"
              >
                Forgot Password? 🔒
              </CardTitle>
              ...
              >
                ...
                <br></br>
                {/* <Card>
                  <span>Please wait for {count} Sec & then Press Resend</span>
                </Card> */}
                {/* <p className="text-center mt-2">
                  <span>
                    <ChevronUp className="mr-25 bg-light" size={14} />
                    <span className="align-middle text-white">Resend OTP</span>
                  </span>
                </p> */}
              </Form>
              <p className="text-center mt-2">
